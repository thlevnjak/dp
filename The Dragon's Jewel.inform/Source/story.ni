...
A candle is here. 
The description is "The candle [if the candle has been lit]is partially burnt[otherwise]is not lit[end if]. It could be helpful when in dark!"
...
The  description is "[if vermithrax is not poisoned]This is the infamous forest of the dragon Vermithrax. He guards the entrance to the cave where your treasure awaits. How do you get around him?[otherwise]The dragon is dead! You are free to enter the cave.[end if]"
